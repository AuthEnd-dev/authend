  ...
  extensionSlots: [
    {
      ...
      exampleDescription: "Create a handler in `apps/api/src/plugins/extensions/organization.ts` and register it from `apps/api/src/plugins/extensions/index.ts`.",
...
export const customOrganizationAccessControl = {
  ...
  permissions: { project: ["update"] },
    ...
    },
    {
      ...
      audience: "server",
      capabilityKeys: ["core"],
      code: `// apps/api/src/plugins/extensions/organization.ts
...
// apps/api/src/plugins/extensions/index.ts
