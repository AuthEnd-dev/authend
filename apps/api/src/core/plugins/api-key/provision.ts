...
export function getApiKeyProvisionPlan(): PluginSqlPlan {
  return {
    key: "plugin_apiKey_v2",
    title: "Enable apiKey plugin",
    sql: `do $$
begin
...
export function getApiKeyRollbackPlan(): PluginSqlPlan {
  return {
    key: "plugin_apiKey_v2",
    title: "Disable apiKey plugin",
    sql: `drop table if exists "apikey" cascade;
